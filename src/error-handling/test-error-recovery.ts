import { ErrorRecoveryManager, RecoveryContext, RecoveryAction, RecoveryPlan } from './error-recovery';
...
class ErrorRecoveryTests {
   ...
   */
  async testBasicRecoveryPlanGeneration(): Promise<void> {
   ...
   */
  async testContextAwareFiltering(): Promise<void> {
   ...
   */
  async testUserExperienceRecovery(): Promise<void> {
   ...
   */
  async testRecoveryActionExecution(): Promise<void> {
    ...
    const attempt = await this.recoveryManager.executeRecoveryAction(
      plan.id,
      plan.recommendedAction.id
    );
   ...
   */
  async testCustomRecoveryStrategy(): Promise<void> {
   ...
   */
  async testRecoveryMetrics(): Promise<void> {
   ...
   */
  async testErrorTypeSpecificRecovery(): Promise<void> {
    ...
    for (const error of errors) {
      ...
      if (error.category === ErrorCategory.SYSTEM) {
        const hasSystemOptimization = plan.actions.some(a => 
          a.description.toLowerCase().includes('memory') || 
   ...
   */
  async testEnvironmentContextDifferences(): Promise<void> {
