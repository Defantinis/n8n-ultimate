import { AdvancedErrorLogger, LogLevel, TelemetryData, LogEntry, AlertRule, MonitoringMetrics } from './error-logger';
...
class ErrorLoggerTests {
  private logger: AdvancedErrorLogger;
   ...
   */
  async testBasicErrorLogging(): Promise<void> {
   ...
   */
  async testGeneralLogging(): Promise<void> {
   ...
   */
  async testLogFiltering(): Promise<void> {
   ...
   */
  async testMonitoringMetrics(): Promise<void> {
   ...
   */
  async testLogExport(): Promise<void> {
   ...
   */
  async testCustomOutputs(): Promise<void> {
    ...
    try {
      ...
      this.logger.addOutput({
        ...
        level: LogLevel.INFO,
        format: 'json',
        customHandler: async (entry: LogEntry) => {
   ...
   */
  async testTelemetryCollection(): Promise<void> {
   ...
   */
  async testErrorCorrelation(): Promise<void> {
   ...
   */
  async testShutdownAndCleanup(): Promise<void> {
