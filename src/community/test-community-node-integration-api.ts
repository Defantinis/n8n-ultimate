...
import { CommunityNodeIntegrationManager, CommunityNodeIntegrationAPI } from './community-node-integration-api';
import type {
  ...
  WorkflowPreferences
} from './community-node-integration-api';
...
function createMockNodeRequirements(): NodeRequirements {
  return {
...
function createMockWorkflowRequirements(): WorkflowRequirements {
  return {
...
export class CommunityNodeIntegrationAPITest {
  private api: CommunityNodeIntegrationManager;
  ...
  private async testNodeDiscovery(): Promise<void> {
    try {
      const options: NodeDiscoveryOptions = {
  ...
  private async testNodeDetails(): Promise<void> {
    try {
  ...
  private async testNodeInstallation(): Promise<void> {
    try {
  ...
  private async testNodeValidation(): Promise<void> {
    try {
  ...
  private async testCompatibilityCheck(): Promise<void> {
    try {
  ...
  private async testNodeIntegration(): Promise<void> {
    try {
  ...
  private async testNodeConfiguration(): Promise<void> {
    try {
  ...
  private async testWorkflowSuggestions(): Promise<void> {
    try {
