...
// Test harness
class TestHarness {
    private processor: ConcurrentProcessor | null = null;
    ...
    public getProcessor(): ConcurrentProcessor {
        if (!this.processor) {
    ...
    public recordResult(testName: string, result: any): void {
...
// Test functions
async function testBasicTaskExecution(harness: TestHarness): Promise<void> {
...
async function testBatchTaskExecution(harness: TestHarness): Promise<void> {
...
async function testPriorityTaskExecution(harness: TestHarness): Promise<void> {
...
async function testDependencyHandling(harness: TestHarness): Promise<void> {
...
async function testParallelExecution(harness: TestHarness): Promise<void> {
...
async function testErrorHandling(harness: TestHarness): Promise<void> {
...
async function testMetricsCollection(harness: TestHarness): Promise<void> {
...
async function testConcurrencyStress(harness: TestHarness): Promise<void> {
...
async function benchmarkPerformance(harness: TestHarness): Promise<void> {
...
// Main test runner
export async function runConcurrentProcessorTests(): Promise<void> {
...
export {
    ...
    testBatchTaskExecution,
    testPriorityTaskExecution,
