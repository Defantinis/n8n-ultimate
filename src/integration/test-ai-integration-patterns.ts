...
import { 
  ...
  AINodeTemplatesClass,
  AIWorkflowPatternsClass,
  AIPerformanceMonitorClass,
 ...
 * Test Configuration
 */
const testConfig: AIIntegrationConfig = {
  ...defaultAIIntegrationConfig,
 ...
 */
export function testAINodeTemplates(): void {
 ...
 */
export function testAIWorkflowPatterns(): void {
 ...
 */
export function testAIPerformanceMonitor(): void {
 ...
 */
export function testAIIntegrationManager(): void {
  ...
  const testWorkflow: N8nWorkflow = {
    id: 'test-workflow',
    name: 'Test Workflow',
    nodes: [
      {
 ...
 * Test AI Utilities
 */
export function testAIUtils(): void {
  ...
  const unknownCost = AIUtils.calculateEstimatedCost('openai', 'unknown-model' as any, 1000, 500);
 ...
 */
export function testWorkflowValidationEdgeCases(): void {
  console.log('🧪 Testing Workflow Validation Edge Cases...');
  
  const manager = new AIIntegrationManagerClass(testConfig);
  
  // Test workflow with no AI nodes
  const noAIWorkflow: N8nWorkflow = {
    id: 'no-ai-workflow',
    name: 'No AI Workflow',
    nodes: [
      {
  ...
  const missingCredsWorkflow: N8nWorkflow = {
 ...
 */
export function testConfigurationHandling(): void {
  console.log('🧪 Testing Configuration Handling...');
  
  // Test with partial configuration
  const partialConfig: Partial<AIIntegrationConfig> = {
  ...
  console.assert(
    openaiNode.parameters.model.value === 'gpt-3.5-turbo',
    'Partial configuration overrides defaults correctly'
  );
  
  // Test with different vector store type
  const vectorConfig: Partial<AIIntegrationConfig> = {
  ...
  console.assert(
    vectorNode.type === 'n8n-nodes-langchain.vectorStorePinecone',
    'Vector store type configuration works correctly'
  );
