import { N8nWorkflow, N8nNode, ValidationResult, ValidationError, ValidationWarning } from '../types/n8n-workflow.js';
import { validateN8nWorkflow, WorkflowValidationResult } from './n8n-workflow-schema.js';
...
export class WorkflowValidator {
   ...
   */
  async validate(workflow: N8nWorkflow): Promise<ValidationResult> {
   ...
   */
  async validateWithN8nSchema(workflow: N8nWorkflow): Promise<WorkflowValidationResult & { legacyValidation: ValidationResult }> {
   ...
   */
  private validateNodes(workflow: N8nWorkflow, errors: ValidationError[], warnings: ValidationWarning[]): void {
    if (!Array.isArray(workflow.nodes)) {
   ...
   */
  private validateNode(node: N8nNode, errors: ValidationError[], warnings: ValidationWarning[]): void {
    // Required fields
   ...
   */
  private validateNodeByType(node: N8nNode, errors: ValidationError[], warnings: ValidationWarning[]): void {
    switch (node.type) {
   ...
   */
  private validateHttpRequestNode(node: N8nNode, errors: ValidationError[], _warnings: ValidationWarning[]): void {
   ...
   * Validate Code node
   */
  private validateCodeNode(node: N8nNode, errors: ValidationError[], _warnings: ValidationWarning[]): void {
    const params = node.parameters;
   ...
   * Validate Start node
   */
  private validateStartNode(node: N8nNode, _errors: ValidationError[], warnings: ValidationWarning[]): void {
   ...
   */
  private validateConnections(workflow: N8nWorkflow, errors: ValidationError[], _warnings: ValidationWarning[]): void {
   ...
   */
  private checkForIsolatedNodes(workflow: N8nWorkflow, warnings: ValidationWarning[]): void {
   ...
   * Validate workflow settings
   */
  private validateSettings(workflow: N8nWorkflow, errors: ValidationError[], warnings: ValidationWarning[]): void {
