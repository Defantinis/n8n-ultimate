...
// Main test runner
export async function runDatabaseIOOptimizerTests() {
    ...
    try {
        ...
        const promises = Array.from({ length: 10 }, (_, i) => optimizer.executeQuery(`SELECT ${i}`));
...
export async function runPerformanceBenchmarks() {
    ...
    const promises = Array.from({ length: 100 }, () => pooledOptimizer.executeQuery('SELECT benchmark'));
...
//# sourceMappingURL=test-database-io-optimizer.js.map