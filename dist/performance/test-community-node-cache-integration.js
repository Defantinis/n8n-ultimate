 ...
 */
import { CommunityNodeCacheIntegration } from './community-node-cache-integration';
import { CommunityNodeMetadataCache } from './community-node-metadata-cache';
/**
 * Test data generator for community node cache integration tests
 */
export class CommunityNodeCacheIntegrationTestData {
    static generateTestNodeMetadata(nodeId = 'test-node') {
        return {
            nodeId,
    ...
    static generateTestSearchOptions(query = 'test') {
        return {
            query,
            category: 'test',
            sortBy: 'popularity',
    ...
    static generateTestValidationResult(nodeId = 'test-node') {
        return {
            nodeId,
            valid: true,
            score: 95,
    ...
    static generateTestCompatibilityResult(nodeId = 'test-node', n8nVersion = '1.0.0') {
        return {
            nodeId,
            n8nVersion,
            compatible: true,
...
class MockCommunityNodeValidator {
    async validateCommunityNode(nodeDefinition, packageInfo) {
...
class MockCommunityNodeIntegrationManager {
    async checkCompatibility(nodeId, n8nVersion) {
...
export class CommunityNodeCacheIntegrationTest {
    ...
    setupTestEnvironment() {
        ...
        this.cacheIntegration = new CommunityNodeCacheIntegration(this.metadataCache, this.mockRegistry, this.mockValidator, this.mockIntegrationManager, this.mockParser, integrationConfig);
    }
    /**
     ...
     */
    async testCompatibilityCaching() {
     ...
     */
    async testSearchResultsCaching() {
     ...
     */
    async testBulkMetadataRetrieval() {
    ...
    async testCacheWarmup() {
        ...
        const warmupIntegration = new CommunityNodeCacheIntegration(this.metadataCache, this.mockRegistry, this.mockValidator, this.mockIntegrationManager, this.mockParser, warmupConfig);
    ...
    async testBackgroundRefresh() {
        ...
        const refreshIntegration = new CommunityNodeCacheIntegration(this.metadataCache, this.mockRegistry, this.mockValidator, this.mockIntegrationManager, this.mockParser, refreshConfig);
 ...
 */
export async function runCommunityNodeCacheIntegrationTests() {
...
//# sourceMappingURL=test-community-node-cache-integration.js.map