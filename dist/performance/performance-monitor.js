...
export class PerformanceMonitor extends EventEmitter {
     ...
     * Track HTTP request
     */
    trackHTTPRequest(responseTime, statusCode) {
     ...
     */
    trackAsyncOperation(operationTime, success = true) {
        if (success) {
     ...
     */
    calculateProfileSummary(profile) {
