...
const real_world_testing_framework_js_1 = require("./real-world-testing-framework.js");
const path = require("path");
async function initializeTestCase() {
    console.log('🚀 Initializing Enhanced n8n Scraper Test Case');
    console.log('==============================================\n');
    const projectRoot = process.cwd();
    const framework = new real_world_testing_framework_js_1.RealWorldTestingFramework(projectRoot);
    try {
