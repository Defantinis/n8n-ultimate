...
export class CommunityNodeRegistryTestSuite {
    ...
    async testCompatibilityValidation() {
        ...
        // Test valid package
        const validResult = await this.registry.validatePackageCompatibility(packageNames[0], '1.0.0');
        ...
        const invalidResult = await this.registry.validatePackageCompatibility('non-existent-package', '1.0.0');
     ...
     */
    async testAdvancedSearchScenarios() {
     ...
     */
    async testVersionCompatibilityEdgeCases() {
        ...
        for (const testCase of testCases) {
            ...
            if (result !== testCase.expected) {
                throw new Error(`Version compatibility test failed: ${testCase.current} vs ${testCase.required} ` +
...
//# sourceMappingURL=test-community-node-registry.js.map