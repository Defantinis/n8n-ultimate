...
export class UserGuideRunner {
     ...
     */
    static getGuidesByCategory(category) {
        return USER_GUIDES.filter(guide => guide.category.toLowerCase() === category.toLowerCase());
    }
    /**
     * Get recommended guides for user level
     */
    static getRecommendedGuides(userLevel) {
