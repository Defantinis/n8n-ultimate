...
(async () => {
    ...
    const wcr = await ReviewService.createWorkflowChangeRequest(workspace.workspace_id, editorId, 'workflow_1', 'Add New Step', 'Proposes adding a new automation step', { nodes: [] });
...
//# sourceMappingURL=collaboration-api.spec.js.map