 ...
 */
import { NodePerformanceKnowledgeBase, NodePerformanceCollector, NodePerformanceAnalyzer, NodePerformanceManager, createNodePerformanceKnowledgeBase } from './node-performance-knowledge-base';
...
class MockKnowledgeStorageManager extends KnowledgeStorageManager {
    ...
    async read(query = {}) {
        ...
        if (query.dateRange) {
            filtered = filtered.filter(item => item.timestamp >= query.dateRange.start &&
 ...
 */
function createMockPerformanceMetrics(nodeId, nodeType, overrides = {}) {
    return {
        nodeId,
        nodeType,
        executionTime: 1000,
...
class NodePerformanceAnalyzerTests {
    ...
    async testAnalyzeNodePerformance() {
...
class NodePerformanceKnowledgeBaseTests {
    ...
    async testPerformanceAnalysisIntegration() {
        await this.knowledgeBase.initialize();
        // Add some test data
...
class NodePerformanceManagerTests {
    ...
    async testManagerCreationWithoutKnowledgeBase() {
...
class NodePerformanceIntegrationTests {
    ...
    async testDataPersistenceAndRetrieval() {
 ...
 */
export async function runNodePerformanceKnowledgeBaseTests() {
 ...
 */
export async function runNodePerformanceQuickTest() {
...
//# sourceMappingURL=test-node-performance-knowledge-base.js.map