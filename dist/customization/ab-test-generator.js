...
export class ABTestWorkflowGenerator {
    generate(config) {
        ...
        const combinedNodes = [routerNode, ...prefixedNodesA, ...prefixedNodesB, mergeNode];
        const combinedConnections = this.generateConnections(routerNodeId, mergeNodeId, workflowA, workflowB);
        return {
    ...
    generateConnections(routerId, mergeId, workflowA, workflowB) {
...
//# sourceMappingURL=ab-test-generator.js.map